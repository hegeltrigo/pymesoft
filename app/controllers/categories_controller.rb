class CategoriesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @category.update(category_params)
        format.html { redirect_to @category, notice: 'Categoría modificada existosamente.' }
  ...
  def destroy
    @category.destroy
    respond_to do |format|
      format.html { redirect_to categories_url, notice: 'Categoría eliminada exitosamente.' }
